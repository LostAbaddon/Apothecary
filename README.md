...
- 邪修与魔：乱我道心者，皆是魔
- 战斗掉落：战斗胜利必定掉落矿石（5~20，中文名显示，直接入宗门仓库），且若仍有未解封卷宗则额外 80% 概率解封一份；失败将按 20%~60% 比例随机掠夺行囊物品
...
- `views/BattleView.vue`
  - 战斗占位界面，模拟胜败并结算奖励/惩罚
  - 掉落卷宗机制（胜利）：
    - 必定获得一份矿石奖励（随机矿种，数量 5~20），直接存入“宗门仓库”并在日志中以矿种中文名显示
    - 若仍有“未解封”的卷宗，则额外以 80% 概率解封其中一份（独立于矿石奖励），日志记录“解封《卷宗名》”
